...
function NavItem(props) {
    ...
    const handleCheckRouteActive = (routeActive, isShowMenu = false) => {
        let isActive = false;
        if (handleCheckRoute(routeActive, location.pathname, params) || isShowMenu) {
            isActive = true;
        }
        return isActive;
    };
        ...
        <>
            {
                route.children && route.children.length > 0 ?
                    <>
                        <div className={`${styles.navItemWrap} ${!isShowSideBar ? styles.navItemCloseWrap : ''} ${
                            handleCheckRouteActive(route.routeActive, isShowMenu) ? (isShowSideBar ? styles.activeNavItemAndSubMenuWrap : styles.navItemActiveWrap) : ''
                        }`}>
                        ...
                        {
                            isShowSideBar ? <ul className={`${styles.menuSubNav} ${
                    ...
                    <>
                        <div
                            className={`${styles.navItemWrap} ${!isShowSideBar ? styles.navItemCloseWrap : ''} ${
